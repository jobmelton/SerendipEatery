  ...
  const onOAuth = useCallback(async () => {
    ...
    try {
      await signIn.authenticateWithRedirect({
        ...
        redirectUrl: 'serendipeatery-biz://sso-callback',
        redirectUrlComplete: 'serendipeatery-biz://sso-callback',
      })
    } catch (err: any) {
...
const styles = StyleSheet.create({
  ...
  badge: { fontSize: 14, fontWeight: '600', color: '#534AB7', textAlign: 'center', marginTop: 4 },
